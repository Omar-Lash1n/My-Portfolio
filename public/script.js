...
const elements =
{
    ...
    get mobileMenuButton() { return document.getElementById('mobile-menu-button'); },
    get mobileMenu() { return document.getElementById('mobile-menu'); },
    get backToTopButton() { return document.getElementById('back-to-top'); },
...
class CustomCursorManager
{
    constructor()
    {
        ...
        this.outlineX = 0;
        this.outlineY = 0;
        this.dotSmoothing = 0.8;
        this.outlineSmoothing = 0.5;
...
// Initialize app exposed to window for Angular
